...
module ElectionGuard.API.Mediator.Generated.Operations.GetElectionConstantsApiV1ElectionConstantsGet where
...
getElectionConstantsApiV1ElectionConstantsGet :: forall m s . (ElectionGuard.API.Generated.Common.MonadHTTP m, ElectionGuard.API.Generated.Common.SecurityScheme s) => ElectionGuard.API.Generated.Configuration s  -- ^ The configuration to use in the request
