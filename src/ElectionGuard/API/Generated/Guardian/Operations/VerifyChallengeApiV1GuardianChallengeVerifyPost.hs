...
-- | Contains the different functions to run the operation verifyChallengeApiV1GuardianChallengeVerifyPost
module ElectionGuard.API.Guardian.Generated.Operations.VerifyChallengeApiV1GuardianChallengeVerifyPost where
...
verifyChallengeApiV1GuardianChallengeVerifyPost config
                                                body = GHC.Base.fmap (GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either VerifyChallengeApiV1GuardianChallengeVerifyPostResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> VerifyChallengeApiV1GuardianChallengeVerifyPostResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
verifyChallengeApiV1GuardianChallengeVerifyPostM body = GHC.Base.fmap (GHC.Base.fmap (\response_3 -> GHC.Base.fmap (Data.Either.either VerifyChallengeApiV1GuardianChallengeVerifyPostResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_4 -> Network.HTTP.Types.Status.statusCode status_4 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> VerifyChallengeApiV1GuardianChallengeVerifyPostResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200)
...
data VerifyChallengeApiV1GuardianChallengeVerifyPostResponse =                                                                 
   VerifyChallengeApiV1GuardianChallengeVerifyPostResponseError GHC.Base.String                                                -- ^ Means either no matching case available or a parse error
  | VerifyChallengeApiV1GuardianChallengeVerifyPostResponse200 VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200  -- ^ Successful Response
  | VerifyChallengeApiV1GuardianChallengeVerifyPostResponse422 HTTPValidationError                                             -- ^ Validation Error
  deriving (GHC.Show.Show, GHC.Classes.Eq)
-- | Defines the data type for the schema VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200
-- 
-- 
data VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200 = VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200 {
  
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.ToJSON VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200
    where toJSON obj = Data.Aeson.object []
          toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))
instance Data.Aeson.Types.FromJSON.FromJSON VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200" (\obj -> GHC.Base.pure VerifyChallengeApiV1GuardianChallengeVerifyPostResponseBody200)
