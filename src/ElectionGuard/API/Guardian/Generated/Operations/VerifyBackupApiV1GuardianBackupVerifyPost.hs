...
-- 
-- Verify Backup
verifyBackupApiV1GuardianBackupVerifyPost :: forall m s . (ElectionGuard.API.Guardian.Generated.Common.MonadHTTP m, ElectionGuard.API.Guardian.Generated.Common.SecurityScheme s) => ElectionGuard.API.Guardian.Generated.Common.Configuration s  -- ^ The configuration to use in the request
...
verifyBackupApiV1GuardianBackupVerifyPost config
                                          body = GHC.Base.fmap (GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either VerifyBackupApiV1GuardianBackupVerifyPostResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> VerifyBackupApiV1GuardianBackupVerifyPostResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    | (\status_2 -> Network.HTTP.Types.Status.statusCode status_2 GHC.Classes.== 422) (Network.HTTP.Client.Types.responseStatus response) -> VerifyBackupApiV1GuardianBackupVerifyPostResponse422 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             HTTPValidationError)
                                                                                                                                                                                                                                    | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0)) (ElectionGuard.API.Guardian.Generated.Common.doBodyCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/api/v1/guardian/backup/verify") [] (GHC.Maybe.Just body) ElectionGuard.API.Guardian.Generated.Common.RequestBodyEncodingJSON)
-- | > POST /api/v1/guardian/backup/verify
-- 
-- The same as 'verifyBackupApiV1GuardianBackupVerifyPost' but returns the raw 'Data.ByteString.Char8.ByteString'
verifyBackupApiV1GuardianBackupVerifyPostRaw :: forall m s . (ElectionGuard.API.Guardian.Generated.Common.MonadHTTP m,
...
verifyBackupApiV1GuardianBackupVerifyPostRaw config
                                             body = GHC.Base.id (ElectionGuard.API.Guardian.Generated.Common.doBodyCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/api/v1/guardian/backup/verify") [] (GHC.Maybe.Just body) ElectionGuard.API.Guardian.Generated.Common.RequestBodyEncodingJSON)
-- | > POST /api/v1/guardian/backup/verify
-- 
-- Monadic version of 'verifyBackupApiV1GuardianBackupVerifyPost' (use with 'ElectionGuard.API.Guardian.Generated.Common.runWithConfiguration')
verifyBackupApiV1GuardianBackupVerifyPostM :: forall m s . (ElectionGuard.API.Guardian.Generated.Common.MonadHTTP m,
                                                            ElectionGuard.API.Guardian.Generated.Common.SecurityScheme s) =>
                                              BackupVerificationRequest ->
...
verifyBackupApiV1GuardianBackupVerifyPostM body = GHC.Base.fmap (GHC.Base.fmap (\response_3 -> GHC.Base.fmap (Data.Either.either VerifyBackupApiV1GuardianBackupVerifyPostResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_4 -> Network.HTTP.Types.Status.statusCode status_4 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> VerifyBackupApiV1GuardianBackupVerifyPostResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                     | (\status_5 -> Network.HTTP.Types.Status.statusCode status_5 GHC.Classes.== 422) (Network.HTTP.Client.Types.responseStatus response) -> VerifyBackupApiV1GuardianBackupVerifyPostResponse422 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              HTTPValidationError)
                                                                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_3) response_3)) (ElectionGuard.API.Guardian.Generated.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/api/v1/guardian/backup/verify") [] (GHC.Maybe.Just body) ElectionGuard.API.Guardian.Generated.Common.RequestBodyEncodingJSON)
-- | > POST /api/v1/guardian/backup/verify
-- 
-- Monadic version of 'verifyBackupApiV1GuardianBackupVerifyPostRaw' (use with 'ElectionGuard.API.Guardian.Generated.Common.runWithConfiguration')
verifyBackupApiV1GuardianBackupVerifyPostRawM :: forall m s . (ElectionGuard.API.Guardian.Generated.Common.MonadHTTP m,
                                                               ElectionGuard.API.Guardian.Generated.Common.SecurityScheme s) =>
                                                 BackupVerificationRequest ->
                                                 Control.Monad.Trans.Reader.ReaderT (ElectionGuard.API.Guardian.Generated.Common.Configuration s)
                                                                                    m
                                                                                    (Data.Either.Either Network.HTTP.Client.Types.HttpException
                                                                                                        (Network.HTTP.Client.Types.Response Data.ByteString.Internal.ByteString))
verifyBackupApiV1GuardianBackupVerifyPostRawM body = GHC.Base.id (ElectionGuard.API.Guardian.Generated.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/api/v1/guardian/backup/verify") [] (GHC.Maybe.Just body) ElectionGuard.API.Guardian.Generated.Common.RequestBodyEncodingJSON)
